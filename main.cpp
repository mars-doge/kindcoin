...
#if defined(NDEBUG)
# error "Kindcoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Kindcoin Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("kindcoin-scriptch");
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // Kindcoin also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // Kindcoin also requires low S in sigs
