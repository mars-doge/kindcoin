...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s kindcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  kindcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded kindcoin transaction") + "\n" +
              "  kindcoin-tx [options] -create [commands]   " + _("Create hex-encoded kindcoin transaction") + "\n" +
              "\n";
