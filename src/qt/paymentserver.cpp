...
const QString BITCOIN_IPC_PREFIX("kindcoin:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/kindcoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/kindcoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/kindcoin-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click kindcoin: links
...
//
// OSX-specific way of handling kindcoin: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in kindcoin: URIs
