...
BOOST_AUTO_TEST_CASE(cashaddr_testvectors_valid)
{
    static const std::string CASES[] = {
        "prefix:x64nx6hz", "PREFIX:X64NX6HZ", "p:gpf8m4h7", "kindcoin:qpzry9x8gf2tvdw0s3jn54khce6mua7lcw20ayyn",
        "kccctest:testnetaddress4d6njnut", "kcccreg:555555555555555555555555555555555555555555555udxmlmrz",
    };
...
BOOST_AUTO_TEST_CASE(cashaddr_testvectors_invalid)
{
    static const std::string CASES[] = {
        ...
        "kcccreg:555555555555555555x55555555555555555555555555udxmlmrz",
        "kcccreg:555555555555555555555555555555551555555555555udxmlmrz", "pre:fix:x32nx6hz", "prefixx64nx6hz",
    };
...
BOOST_AUTO_TEST_CASE(cashaddr_testvectors_noprefix)
{
    static const std::pair<std::string, std::string> CASES[] = {
        {"kindcoin", "qpzry9x8gf2tvdw0s3jn54khce6mua7lcw20ayyn"}, {"prefix", "x64nx6hz"}, {"PREFIX", "X64NX6HZ"},
        {"p", "gpf8m4h7"}, {"kindcoin", "qpzry9x8gf2tvdw0s3jn54khce6mua7lcw20ayyn"},
        {"kccctest", "testnetaddress4d6njnut"}, {"kcccreg", "555555555555555555555555555555555555555555555udxmlmrz"},
    };
