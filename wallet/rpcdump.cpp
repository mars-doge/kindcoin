...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"kindcoinaddress\"\n"
            "\nReveals the private key corresponding to 'kindcoinaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"kindcoinaddress\"   (string, required) The kindcoin address for the private key\n"
            "\nResult:\n"
